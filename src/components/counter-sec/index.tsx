    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 items-center md:gap-3 bg-zinc-100 py-5 px-16 md:px-10 md:py-12 lg:px-14 xl:px-28">
                ...
                <div className="relative pt-8 pb-4 px-8 rounded-md bg-white shadow-2xl/50 shadow-zinc-400 my-8 md:my-6 flex flex-col justify-center items-center gap-3">
                    <h4 className="text-4xl font-bold text-zinc-500">233</h4>
                ...
                <div className="relative pt-8 pb-4 px-8 rounded-md bg-white shadow-2xl/50 shadow-zinc-400 my-8 md:my-6 flex flex-col justify-center items-center gap-3">
                    <h4 className="text-4xl font-bold text-zinc-500">19</h4>
                ...
                <div className="relative pt-8 pb-4 px-8 rounded-md bg-white shadow-2xl/50 shadow-zinc-400 my-8 md:my-6 flex flex-col justify-center items-center gap-3">
                    <h4 className="text-4xl font-bold text-zinc-500">508</h4>
                ...
                <div className="relative pt-8 pb-4 px-8 rounded-md bg-white shadow-2xl/50 shadow-zinc-400 my-8 md:my-6 flex flex-col justify-center items-center gap-3">
                    <h4 className="text-4xl font-bold text-zinc-500">1463</h4>
